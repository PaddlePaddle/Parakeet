...
import torch
import numpy
from encoder import Encoder as EncoderPrenet
from encoder_torch import Encoder as EncoderPrenet_torch
...
np_query = numpy.random.rand(2,10)

query = paddle.to_tensor(np_query,dtype = 'int64')

query_torch = torch.tensor(np_query,dtype = torch.int64)
...
encoder_prenet_torch = EncoderPrenet_torch(
                    idim=idim,
                    embed_dim=embed_dim,
                    elayers=0,
                    econv_layers=eprenet_conv_layers,
...
paddle_result = encoder_prenet(query)
print(paddle_result)
print(paddle_result.shape)
torch_result = encoder_prenet_torch(query_torch)
print("---------------")
print(torch_result)
