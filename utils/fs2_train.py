...
from parakeet.training.fastspeech2_updater import FastSpeech2Evaluator
from parakeet.training.fastspeech2_updater import FastSpeech2Updater
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train a FastSpeech2 model with sigle speaker dataset.")
